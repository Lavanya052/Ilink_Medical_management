  ...
  const renderStepOne = () => (
    <>
      <div className="ml-5 mr-5">
        <label className="block mb-2 font-medium">Doctor Image:</label>
  ...
  return (
   <>
    <div className="flex m-4 ">
      ...
      <div className="lg:w-2/3 w-full bg-white shadow-md rounded-xl p-2 max-w-4xl mt-12">
        <h2 className="text-3xl font-bold mb-4 text-center text-blue-500 mt-2">Register Doctor</h2>
        <form onSubmit={submitDoctor} className="grid grid-cols-2">
          {step === 1 && renderStepOne()}
          {step === 2 && renderStepTwo()}
          {step > 1 && (
          <>
            <br />
            <div className="col-span-1 flex justify-start ml-4 mt-4">
          ...
          <div className="col-span-1 flex justify-end items-end mt-4">
            {step === 2 && <Button value={"Register"} type="submit" />}
          </div>
        </form>
        <ToastContainer />
      </div>
